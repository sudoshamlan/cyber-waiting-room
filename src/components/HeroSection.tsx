...
const HeroSection: React.FC = () => {
  return <div className="min-h-[85vh] flex flex-col items-center justify-center relative overflow-hidden px-4 sm:px-6">
      {/* Hero content */}
      <div className="max-w-4xl mx-auto text-center">
        <h1 className="text-3xl sm:text-4xl md:text-5xl lg:text-6xl font-extrabold mb-6">
          
          <TypewriterEffect text="Your Business Data, One Text Away" className="text-xl sm:text-2xl md:text-3xl text-white opacity-80" />
        </h1>
